...
public class MapActivity extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int i = 0; i < ParserUtils.getObjectCount(this, "place"); i++) {

            LatLng location = ParserUtils.getFieldLatLng(this, "place", Integer.toString(i));
            if (location != null) {

                Marker marker = mMap.addMarker(new MarkerOptions()
                        .position(location)
                        .title(ParserUtils.getFieldText(this, "place", Integer.toString(i), "title"))
                        .snippet(ParserUtils.getFieldText(this, "place", Integer.toString(i), "desc")));
                marker.setTag(ParserUtils.getFieldText(this, "place", Integer.toString(i), "id"));
            } else {
